...
import { G1_PENGHASILAN_OPTIONS } from "../gelombang1Types";

const G1Step3DataOrtu: React.FC<G1StepProps> = ({ form, setForm, errors }) => {
  const handleChange = (
    e: React.ChangeEvent<
...
export default G1Step3DataOrtu;
