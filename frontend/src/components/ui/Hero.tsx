 ...
 * welcome message, description text, and a call-to-action button for student registration.
 */
 ...
 * Displays a welcoming message with a call-to-action button for prospective students.
 */
const Hero: React.FC = () => {
  return (
