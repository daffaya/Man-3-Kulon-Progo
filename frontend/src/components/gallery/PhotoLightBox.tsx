...
import ImageWithFallback from "../ui/ImageWithFallback"; // Import kembali ImageWithFallback
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90">
      ...
      {photos.length > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed z-10"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed z-10"
      ...
      <div className="relative max-w-7xl max-h-[90vh] mx-auto p-4">
        ...
        {imageError ? (
          ...
          // Gunakan ImageWithFallback untuk menangani error dengan lebih baik
          <ImageWithFallback
