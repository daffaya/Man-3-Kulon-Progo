/**
 * @fileoverview Router for managing admin category-related endpoints.
 * This module defines and configures an Express router for CRUD operations on categories.
